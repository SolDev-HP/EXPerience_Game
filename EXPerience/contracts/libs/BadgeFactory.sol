...
library BadgeFactory {
    ...
    function _base64EncodeImage(uint256 _tokenAmount, ColorDetails memory _colors) internal pure returns (string memory) {
    ...
    function _generateTokenURI(uint256 _nftID, uint256 _tokenAmount, address _owner, ColorDetails memory _colorSelector) internal pure returns (string memory tokenURI) {
        ...
        string memory _imgUrl = _base64EncodeImage(_tokenAmount, _colorSelector);
