...
def main():
    ...
    # Add another admin
    EXPerience.setTokenAdmins(os.getenv("PUBLIC_KEY_ADMIN2"), True, {"from": admin2_account})
    ...
    EXPerience.gainExperience(os.getenv("PUBLIC_KEY_HODLER1"), 1 * 10 ** 18, {"from": hodler1_account})
    # Mint some EXP to Hodler2 from Admin2 
    EXPerience.gainExperience(os.getenv("PUBLIC_KEY_HODLER2"), 1 * 10 ** 18, {"from": hodler2_account})
